    ...
    <section id="outlet" className="py-20 bg-white text-slate-800 border-t border-slate-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-12">
          <span className="text-xs font-black tracking-widest text-red-800 uppercase">Lokasi Cabang</span>
            ...
            >
              <div>
                <div className="relative w-full h-48 rounded-2xl overflow-hidden mb-4 bg-white">
                  ...
                  />
                  <div className="absolute top-3 left-3 px-3 py-1 rounded-full bg-emerald-700 text-white text-[11px] font-bold shadow-sm flex items-center gap-1">
                    <Check className="w-3.5 h-3.5" />
                    <span>{outlet.status}</span>
                  </div>
                </div>

                <h3 className="font-extrabold text-base sm:text-lg text-slate-900 group-hover:text-red-800 transition-colors leading-snug">
                  {outlet.name}
                </h3>
              ...
              <div className="mt-6 pt-4 border-t border-slate-200/80 flex items-center gap-2">
                ...
                >
                  <MapPin className="w-3.5 h-3.5 text-red-800" />
                ...
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="p-2.5 rounded-full bg-red-800 hover:bg-red-900 text-white transition-colors"
