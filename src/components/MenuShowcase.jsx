    ...
    <section id="menu" className="py-16 bg-white text-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center max-w-2xl mx-auto mb-10">
          <span className="text-xs font-black tracking-widest text-red-800 uppercase">Daftar Menu</span>
          ...
          <div className="flex items-center gap-2 w-full md:w-72">
            <div className="relative w-full">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-2.5 rounded-full bg-slate-50 border border-slate-200 text-xs sm:text-sm focus:outline-none focus:ring-2 focus:ring-red-800 text-slate-800 placeholder-slate-400"
              />
              {searchQuery && (
                <button
        ...
        {filteredItems.length > 0 ? (
          ...
          <div className="py-16 text-center bg-slate-50 rounded-3xl border border-dashed border-slate-200">
            ...
            <button
              ...
              className="mt-4 px-5 py-2 rounded-full bg-red-800 text-white text-xs font-bold shadow-sm"
            >
              Reset Filter
            </button>
          </div>
        ...
        {activeCategory === 'topping' || activeCategory === 'all' ? (
          <div className="mt-16 pt-12 border-t border-slate-100">
            <div className="max-w-2xl mb-6">
              <span className="text-xs font-black tracking-widest text-red-800 uppercase">Ekstra Topping</span>
              ...
              {SABUBA_DATA.extraToppings.map((topping) => (
                ...
                >
                  <div>
                    ...
                    <span className="text-xs font-extrabold text-red-800 mt-0.5 block">
                      +{formatRupiah(topping.price)}
                    </span>
                  </div>
                  <button
                    onClick={() => onAddToCart({ ...topping, category: 'topping', isToppingOnly: true })}
                    className="p-2 rounded-full bg-red-800 hover:bg-red-900 text-white text-xs font-bold shadow-sm"
                  >
